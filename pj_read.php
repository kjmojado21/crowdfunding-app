<?php
    ...
    $project_list = $profileObj->read_project();
...
#ads .ad-title h5 {
  ...
  <div class="container">
    ...
    <h2>Search & Support Project 
        ...
        <?php }else{ ?>
        <a href="index.php" class="btn btn-warning float-right">Login / Sign Up</a>
        <?php } ?>
    </h2>
	<br>
    ...
    <div class="col-md-4 mt-4">
        <div class="card rounded">
            ...
            <div class="card-image-overlay m-auto">
                ...
                <small>
                    Support: <?php if($total_project_support['tp_support']==false){echo "0";}else{echo $total_project_support['tp_support'];} ?> / <?php echo $row['total_support'] ?> PHP
                </small><br>  
            ...
            <div class="card-body text-center">
                ...
                <a class="ad-btn" href="pj_detail.php?project_id=<?php echo $project_id ?>"><small>Detail & Support</small></a>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
